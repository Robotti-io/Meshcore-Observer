...
- **Expected tests / validation:** Bootstrap/lifecycle tests or focused wiring tests as supported by the existing suite; full `npm test` and `npm run lint`; any manual hardware verification uses COM4 and does not connect to COM3.
